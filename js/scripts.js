class Validator {
  ...
  minlength(input, minValue) {
    ...
    let errorMessage = `O campo precisa ter pelo menos ${minValue} de caracteres`;
  ...
  maxlength(input, maxValue) {
    ...
    let errorMessage = `O campo precisa ter menos que ${maxValue} de caracteres`;
  ...
  emailvalidate(input) {
    ...
    let errorMessage = `Insira um e-mail no padrão xxxxxx@email.com`;
